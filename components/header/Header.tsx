...
export const Header = () => {
  ...
  return (
    <header className="overflow-x-hidden px-8 pr-0 lg:px-0 bg-[#111827] sticky top-0 z-30 lg:z-10 grid grid-cols-3 justify-between lg:grid-cols-[auto_1fr_auto] shadow-yellow-200 shadow-md hover:shadow-lg hover:shadow-yellow-300 transition">
