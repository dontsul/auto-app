    ...
    <div className=" pb-20 grid lg:grid-cols-[140px_auto_240px] gap-12  justify-center">
      ...
      <div className="flex justify-between ">
        <div className="flex flex-col">
          {currentText === "PRIME CS" && (
            <h1 className="text-[60px] text-red-500 font-semibold">250$</h1>
          )}
          {currentText === "PRIME XR" && (
            <h1 className="text-[60px] text-red-500 font-semibold">350$</h1>
          )}
          {currentText === "PRIME SD" && (
            <h1 className="text-[60px] text-red-500 font-semibold">450$</h1>
          )}
          <div>
