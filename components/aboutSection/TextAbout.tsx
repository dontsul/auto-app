...
export function TextAbout (){
    return (
        <div className=" z-10 p-4 col-span-10 flex md:col-span-5  items-center justify-center px-5 md:px-10 hover:scale-105 transition-transform duration-300">
            <h3 className="text-center relative z-20">
                ...
                <span className=" text-[16px] text-center mb-2 h-1 w-5 rounded-full " style={{ display: 'inline-block', width: '100%', textAlign: 'center' }}>
