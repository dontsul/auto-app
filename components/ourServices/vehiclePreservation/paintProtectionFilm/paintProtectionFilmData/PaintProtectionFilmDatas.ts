...
export const paintProtectionFilmText: ITitleTintPagesProps[] = [
    {
        value: "FULL BODY",
...
export const PaintProtectionFilm = ["Front Bumper","Headlights","Fog Lights","Full Hood"," Full Front Fenders","Mirror Caps"];
export const PaintProtectionFilm2 = ["Front Bumper","Entire Hood","Both Full Fenders","Headlights & Fog Lights","Mirror Caps","Rocker Panels","Quarter Panels","A-Pillars" ];
export const PaintProtectionFilm3 = ["All Painted Exterior Surfaces", "Headlights & Tail Lights","Fog Lights"];
export const PaintProtectionFilm4 = ["Full PPF & Ceramic Coating","Xpel Ultimate Plus film","Xpel Fusion Premium 8yr","All Painted Exterior Surfaces","Headlights & Tail Lights","Fog Lights"];
