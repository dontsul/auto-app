...
export function TextAbout() {
    return (
        <div
            className=" z-10 p-5 flex order-2 lg:order-1   items-center justify-center px-10 md:px-10  transition-transform duration-300">
            <p className="leading-6 py-7 text-[16px]  mb-2  rounded-full "
               style={{color: '#616161', display: 'inline-block', width: '100%'}}>
                Welcome to <strong>Capital Upfitters</strong>, the family-owned epicenter of top-tier auto
                customization,
